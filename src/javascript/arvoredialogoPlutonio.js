...
const dialogo = {
  inicio: {
    texto:
      "Bom dia, nobres colegas! Eu sou o Mr. Plutônio, e sim, antes que perguntem, aquele Plutônio, das Indústrias Plutônio. Vim pessoalmente, o que já demonstra a seriedade desta proposta. Poderiam ao menos fingir surpresa.",
    opcao1: "Próximo",
    proximo1: "conceito1",
    opcao2: null,
    proximo2: null,
  ...
  conceito3: {
    texto:
      "O que não podemos julgar como verdadeiro ou falso não é proposição: perguntas, ordens, pedidos, exclamações, sentenças abertas, desejos ou opiniões. Uma proposta vaga, sem números fechados, é exatamente isso, inútil tanto na lógica quanto nos negócios.",
    opcao1: "Entendi!",
    proximo1: "resposta1a",
    opcao2:
      "Se negócio com números é difícil, então negócio com escola pública é impossível",
    proximo2: "resposta1b",
  },
  ...
  disjuncaoIntro: {
    texto:
      'Mas existe outro conectivo muito usado em negociações: a disjunção. Ela é representada pelo símbolo V e corresponde à palavra "ou". Quando escrevemos A V B, lemos "A ou B". Nela, basta que uma das proposições seja verdadeira para que a expressão inteira seja verdadeira.',
  ...
  despedida: {
    texto:
      "Agradeça votando a favor da minha empresa, colega. Nos vemos na próxima sessão, ou nos corredores, se me permitirem circular por eles. Até mais!",
    opcao1: "RETURN",
    proximo1: null,
    opcao2: null,
    proximo2: null,
