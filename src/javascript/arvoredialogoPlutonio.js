...
const dialogo = {
    ...
    conceito1: {
        texto: "Antes de falarmos de privatização, preciso que dominem um conceito básico, do contrário nossa negociação vai por água abaixo: proposição. Prestem atenção, porque não repito duas vezes, ou melhor, repito, mas cobro juros.",
        opcao1: "Próximo",
        proximo1: "conceito2",
        opcao2: null,
        proximo2: null,
    ...
    conceito2: {
        texto: "Proposição é toda frase que se consegue classificar como verdadeira ou falsa. Nada de ambiguidade, nada de \"depende do ponto de vista\".",
        opcao1: "Próximo",
        proximo1: "conceito3",
        opcao2: null,
        proximo2: null,
    ...
    resposta1b: {
        texto: "Sua afirmativa é falsa, mas o raciocínio é surpreendentemente lógico para quem não usa terno. Vamos adiante.",
        opcao1: "Próximo",
        proximo1: "pergunta1",
        opcao2: null,
        proximo2: null,
    ...
    pergunta1: {
        texto: "Com base no que expliquei, a frase \"A privatização é vantajosa se e somente se não houver prejuízo à comunidade.\" é uma proposição?",
        opcao1: "Sim",
    ...
    pergunta1Certo: {
        texto: "Correto! É proposição porque é declarativa e tem valor de verdade determinável, apesar de ser uma afirmativa falsa. Afinal, não nos importamos com prejuízos à comunidade.",
        opcao1: "Próximo",
        proximo1: "pergunta2",
        opcao2: null,
        proximo2: null,
    ...
    pergunta1Errado: {
        texto: "Errado... é proposição porque conseguimos julgar se é verdadeira ou falsa. Prestem mais atenção da próxima vez, o tempo de um empresário é precioso.",
        opcao1: "Próximo",
        proximo1: "pergunta2",
        opcao2: null,
        proximo2: null,
    ...
    pergunta2Certo: {
        texto: "Isso mesmo! E fizeram uma ótima observação: a escola é pública, porém a frase não é proposição, pois \"isso\" não diz a que se refere, não dá para julgar se \"isso será vendido\" é verdade ou mentira. Ambiguidade, a inimiga de todo bom contrato.",
        opcao1: "Próximo",
    ...
    pergunta2Errado: {
        texto: "Errado!!! Não é proposição, pois \"isso\" não diz a que se refere, não dá para julgar se \"isso será vendido\" é verdade ou mentira.",
        opcao1: "Próximo",
        proximo1: "conjuncaoIntro",
        opcao2: null,
        proximo2: null,
    ...
    conjuncaoExemplo: {
        texto: "O projeto foi aprovado e o investimento não foi liberado. De acordo com isso, a conjunção é:",
        opcao1: "Verdadeira",
    ...
    conjuncaoErrado: {
        texto: "Errado, se uma preposição é falsa, a conjunção inteira também será. Vejo que o senhor não é um investidor muito competente….",
        opcao1: "Próximo",
    ...
    conjuncaoCerto: {
        texto: "Acertou. Fico satisfeito em ver que consegue acompanhar um raciocínio tão simples.",
        opcao1: "Próximo",
        proximo1: "disjuncaoIntro",
        opcao2: null,
        proximo2: null,
    ...
    disjuncaoExemplo: {
        texto: "O governo OU a iniciativa privada financiará o projeto. Imagine que apenas a iniciativa privada financie o projeto, essa disjunção seria:",
        opcao1: "Verdadeira",
    ...
    disjuncaoErrado: {
        texto: "Errado, apenas uma proposição ser verdadeira já basta para a disjunção ser verdadeira.",
        opcao1: "E se o governo e a iniciativa privada financiassem o projeto?",
        proximo1: "disjuncaoAmbos",
        opcao2: null,
        proximo2: null,
    ...
    disjuncaoAmbos: {
        texto: "Se as duas forem verdadeiras ao mesmo tempo, a disjunção também continua sendo verdadeira. Mas seria meio irrealista pensar que dessa vez o governo ficaria do nosso lado…",
        opcao1: "Próximo",
    ...
    condicionalExemplo: {
        texto: "Se o contrato for assinado, então o investimento será liberado. Imagine que o contrato foi assinado, mas o investimento não foi liberado. Essa condição seria:",
        opcao1: "Verdadeira",
    ...
    condicionalCerto: {
        texto: "Correto. O contrato foi assinado, mas o investimento não foi liberado. A promessa falhou, e isso torna a condicional falsa.",
        opcao1: "Próximo",
    ...
    condicionalErrado: {
        texto: "Errado. Quando a condição acontece e a consequência não acontece, a condicional é falsa. Em negociações, esse é o tipo de cláusula que costuma acabar nos tribunais.",
        opcao1: "Próximo",
        proximo1: "bicondicionalIntro",
        opcao2: null,
        proximo2: null,
    ...
    bicondicionalIntro: {
        texto: "Agora o último conectivo: a bicondição. Ela é representada por ↔ e é lida como \"A se e somente se B\".",
    ...
    bicondicionalExplicacao: {
        texto: "Ela exige compromisso dos dois lados. A condição vale na ida e na volta. Se A acontece, B também deve acontecer; e se B acontece, A também deve acontecer.",
    ...
    bicondicionalExemplo: {
        texto: "A empresa receberá exclusividade se e somente se investir no projeto. Imagine que a empresa investiu no projeto e recebeu exclusividade. Essa bicondição seria:",
        opcao1: "Verdadeira",
    ...
    bicondicionalCerto: {
        texto: "Correto. As duas condições foram satisfeitas, então a bicondição é verdadeira.",
        opcao1: "Próximo",
        proximo1: "final",
        opcao2: null,
        proximo2: null,
    ...
    bicondicionalErrado: {
        texto: "Errado. Quando as duas proposições têm o mesmo valor lógico, a bicondição é verdadeira.",
        opcao1: "Próximo",
        proximo1: "final",
        opcao2: null,
        proximo2: null,
    ...
    final: {
        texto: "Muito bem, nobres colegas, por hoje encerro por aqui, inclusive porque meu motorista está esperando.",
